...
import DayReflection from '@/components/diary/DayReflection.vue'
import DiaryContent from '@/components/diary/DiaryContent.vue'
import EmotionalBalance from '@/components/diary/EmotionalBalance.vue'
import EmotionalState from '@/components/diary/EmotionalState.vue'
import GentleGuidance from '@/components/diary/GentleGuidance.vue'
import GratitudeReflections from '@/components/diary/GratitudeReflections.vue'
import KeyThemes from '@/components/diary/KeyThemes.vue'
import StressLevel from '@/components/diary/StressLevel.vue'
